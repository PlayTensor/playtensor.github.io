...
He is also quick to add that he tried to follow a personal rule in his asset use. "I only use assets released under permissive licenses that allow modification, and I make sure to touch and modify every asset," says Jack. "The goal is to make everything fit together into a coherent whole, so making sure to at least touch every asset inside an editor forces me to think carefully about how the asset fits into the game before actually putting it in, and make appropriate changes if necessary."

Some of these changes took the form of optimizations. "I don't want to point any fingers or sound ungrateful to all the great 3D model creators who so generously release their work for free under permissive licenses, but I was amazed at how many triangles were in some of the models tagged as 'low poly.' The game has a pretty low polygon budget, so I had to spend a fair bit of time modifying a few assets to get the triangle count down to fit in the budget."

Another justification for building on top of pre-made assets, at least according to Jack, is that it meant he could spend more time and energy on other parts of the game. "There are some things that can't really be outsourced to unwitting contributors very well," he says. "Yeah, I can kitbash pre-existing 3D models into something that looks like a cool new rifle, but it's a lot harder for me to cobble together a level editor or a monster AI out of someone else's code."

By late 2022, Jack had come to the suspect that the tile-based level editor and monster AI might become the game's core features. To that end, he began working on a built-in editor that players could access within the game to create and play their own levels, which required crash courses in data encoding and user interface design. Building a monster AI flexible enough to manage almost any possible player created map meant extensive study of game AI techniques and long periods of wild experimentation, with the monster AI being thrown out and restarted multiple times. What had originally supposed to have been a simple Wolfenstein 3D clone "tech demo" to be released in 2022 was scope creeping into continued development in 2023.
...
"Anonymous play testers can be brutal in their feedback sometimes," continues Jack. "But that's a good thing. It can be painful to read, but you have to take the bad with the good. It hurts being told 'all your work is garbage and by extension you are garbage,' but you have to remember that the goal isn't to feel good, it's to make an amazing product. Study their feedback, figure out what made them mad, and improve the product to address the problem."

"The overwhelming majority of feedback is very civil anyways," he quickly adds. "I'd say the comments that get mad enough to try to make it personal were probably one out of a hundred, maybe even fewer. It's just that the angriest comments can sometimes get stuck in your head if you're not careful."
